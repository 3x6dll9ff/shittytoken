...
import PopupMenu from "../popup-menu.jsx";
import userAPI from "../../scripts/user-api.js";
import {walletInstalled, okxReplaces, connectWallet} from "../../scripts/wallets_connector.js";
import {
...
const WalletsPopupButton = ({wallet, onWalletConnect}) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`header-profile-wallet-popup-button-wallet-name-text-container ${walletInstalled(wallet) ? '' : 'disabled'}`}>
                <div
                    className={`header-profile-wallet-popup-button-wallet-name-text ${walletInstalled(wallet) ? '' : 'disabled'}`}>
