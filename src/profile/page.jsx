...
const ProfileSubtitle = ({className, type = 'big', children}) => {
    ...
    return (
        ...
        >
            <div className={`profile-subtitle ${titleTypes[type]}`}>
                <h1>{children}</h1>
            </div>
        </div>
    );
    ...
    return (
        <>
            ...
            <div className={`profile-id-card-container`}>
                <ProfileSubtitle>ID CARD</ProfileSubtitle>
...
const SeasonPass = ({userAccount}) => {
    ...
    return (
        <div className={`profile-season-pass-container`}>
            <ProfileSubtitle>ANTI PASS</ProfileSubtitle>
...
const Slides = () => {
    ...
    return (
        Array.from({length: 6})
            .map((_, index) => {
                return (
                    <QuestCard questInfo={questInfo} key={index}/>
                )
            })
    );
};
